...
lexus = SportCar(110, 'grey', 'lexus', False)
volga = TownCar(45, 'black', 'volga', False)
lada = WorkCar(75, 'Red', 'lada', True)
audi = PoliceCar(100, 'blue','Audi', True)
print(lada.turn_left())
print(f'When {volga.turn_right()}, then {volga.stop()}')
...
print(f'Is {volga.name}  a police car? {volga.is_police}')
